...
class PubsControllerTest < ActionController::TestCase
  ...
  test "should create pub" do
    assert_difference('Pub.count') do
      post :create, pub: { address: @pub.address, city: @pub.city, name: @pub.name, state: @pub.state, zip: @pub.zip }
    end
  ...
  test "should update pub" do
    put :update, id: @pub, pub: { address: @pub.address, city: @pub.city, name: @pub.name, state: @pub.state, zip: @pub.zip }
    assert_redirected_to pub_path(assigns(:pub))
  end
